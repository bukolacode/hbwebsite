...
<body class="bg-light">
 ...
 <?php include "./includes/header.php"; ?>
  ...
  <div class="container-fluid" id="main-content">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="text-end mb-3">
                <button type="button" class="btn btn-dark btn-sm shadow-none" data-bs-toggle="modal" data-bs-target="#ard-room">
    ...
    <div class="modal fade" id="ard-room" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                              ...
                              while ($opt = mysqli_fetch_assoc($res)){
                                echo "
                                   <div class='col-md-3 mb-1'>
                                     <label>
                                      <input type='checkbox' name='features' value='$opt[id_no]' class='form-check-input shadow-none'>
                                      $opt[name]
                                     </label>
                                   </div>
                                ";
                            ...
                            <?php
                              ...
                              while ($option = mysqli_fetch_assoc($res)){
                                echo "
                                   <div class='col-md-3 mb-1'>
                                     <label>
                                      <input type='checkbox' name='facilities' value='$option[id]' class='form-check-input shadow-none'>
                                      $option[name]
                                     </label>
                                   </div>
                                ";
