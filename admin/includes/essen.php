<?php 
  ...
  // backend ipload process needs this data
  ...
  define('SENDGRID_API_KEY','SG.U7CG20LwbTmKIOS-c9kllsg.TiFuqFJyyV20GGarjwx2JFkgrXvC9SrUFEQLScblhdo');
  define('SENDGRID_EMAIL','bkwebdev87@gmail.com');
  define('SENDGRID_NAME','Elizabeth');
  ...
  function adminLogin(){
   ...
   function alert($types,$msg){ 
    $bs_class = ($types = "success") ? "alert-success" : "alert-danger";
    echo <<<alert
 ...
 function deleteImage($image,$folder){
    if (unlink(UPLOAD_IMAGE_PATH.$image.$folder)){
      return true;
    }else{
      return false;
    }
