 ...
 <?php include "./includes/header.php"; ?>
  ...
  <div class="container-fluid" id="main-content">
            ...
            <form id="featform">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="fname" name="fname" autocomplete="off" class="form-control shadow-none" required>
                    </div>
    ...
    <div class="modal fade" id="facility-s" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form id="facilities-s-form" autocomplete="off">
                <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" id="facility_icon"  name="facility_icon" accept=".svg" class="form-control shadow-none" required>
                    </div>
                    <div class="mb-3">
