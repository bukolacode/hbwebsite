        ...
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
           ...
           <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                ...
                <h6 class="card-subtitle md-1">About Us</h6>
         ...
         <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                ...
                <p class="card-text">
                    No customer will be able to book hotel rooms, when shutdown mode is on.
                </p>
            </div>
         </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="mb-4">
                        <h6 class="card-subtitle md-1 fw-bold">Google Map</h6>
                        <p class="card-text" id="gmap"></p>
                      </div>
                      <div class="mb-4">
                        <h6 class="card-subtitle md-1 fw-bold">Phone Numbers</h6>
                      ...
                      <div class="mb-4">
                        <h6 class="card-subtitle md-1 fw-bold">E-mail</h6>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4">
                            <h6 class="card-subtitle md-1 fw-bold">Iframe</h6>
