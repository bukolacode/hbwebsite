 <div class="container-fluid bg-white mt-5">
   <div class="row">
     <div class="col-lg-4 p-4">
        ...
        <p><?php echo $settings_r['site_about'] ?>
        </p>
     </div>
     <div class="col-lg-4 p-4">
  ...
  <h6 class="text-center text-white bg-dark p-3 m-0">Designed and developed by Bukola </h6>
  ...
  <script>
    ...
    function alert(type,msg,position='body'){
      ...
      element.innerHTML = `
        <div class="alert ${bs_class} alert-dismissible fade show custon-alert">
      ...
      `; 
          if (position=='body') {
            ...
            documet.getElementById(position).appendchild(element);
          }
  ...
  function remAlert(){
       ...
       modal.hide();
        ...
        xhr.onload = function(){
          if(this.responseText == 'Pass_mismatch'){
            ...
            alert('success', 'Registration successful. Confirmation link send to your email!');
            register_form.reset();
          }
        }
       ...
       modal.hide();
        ...
        xhr.onload = function()
        {
          if(this.responseText == 'inv_email_mob'){
            alert('error', 'Invali email or mobile number!');
          }
    ...
    //    let data = new FormData();
    //    data.append('email',forgot_formrm.elements['email'].value);
