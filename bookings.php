...
<div class="container">
 <div class="row">
    ...
    <?php
     ...
     WHERE ((bo.booking_status ='boooked') OR (bo.booking_status ='cancelled') OR (bo.booking_status='payment failed')) 
     AND (bo.user_id=?)
        ...
        if($data['booking_status'] == 'booked')
        {
            ...
            if($data['arrival'] == 1)
            {
              ...
              if($data['rate_review']==0){
                $btn .= "<button type='button' onclick='review_room($data[booking_id],$data[room_id])' class='btn btn-dark btn-sm shadow-none ms-2' data-bs-toggle='modal' data-bs-target='#reviewModal'>Rate & Review</button>";
              }
            }
            else{
